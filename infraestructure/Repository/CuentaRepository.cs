...
namespace Infraestructure.Repository
{
    public class CuentaRepository
    {
        ...
        public string InsertarCuenta(CuentaModel cuenta)
        {
            try 
            {
                String query = "insert into cuenta(id_persona, nombre, numero, saldo, limite_saldo, limite_transferencia, estado) " +
                    " values(@id_persona, @nombre, @numero, @saldo, @limite_saldo, @limite_transferencia, @estado)";
                connection.Open();
